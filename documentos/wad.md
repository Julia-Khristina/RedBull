...
Na Sprint 4, os diagramas foram revisados e validados contra o código implementado. As nomenclaturas das camadas foram padronizadas para o idioma inglês (`checkpointController`, `checkpointService`, `checkpointRepository`), alinhando-se à refatoração realizada no backend. Dois novos fluxos foram mapeados: autenticação de administrador e registro de checkpoint, ambos refletindo os endpoints reais disponíveis na API.
...
*AtÃ© 300 palavras, sem necessidade de fonte.*

*Apresente de forma clara e objetiva os principais destaques do projeto, incluindo: oportunidade identificada no mercado; problema atendido pela aplicaÃ§Ã£o; diferenciais competitivos da aplicaÃ§Ã£o web; e objetivos estratÃ©gicos pretendidos.*

*Valor: atÃ© 1,0 ponto.*

## 6.2 AnÃ¡lise de Mercado

*AtÃ© 800 palavras, com fontes obrigatÃ³rias.*

### 6.2.1 VisÃ£o Geral do Setor

*AtÃ© 250 palavras.*

*Contextualize o setor em que a aplicaÃ§Ã£o estÃ¡ inserida, considerando aspectos econÃ´micos, tecnolÃ³gicos e regulatÃ³rios. Utilize fontes confiÃ¡veis.*
...
*Apresente dados quantitativos que demonstrem o tamanho atual e as perspectivas de crescimento do mercado. Utilize fontes confiÃ¡veis.*

*Valor: atÃ© 1,0 ponto.*

### 6.2.3 TendÃªncias de Mercado

*AtÃ© 300 palavras.*

*Identifique tendÃªncias tecnolÃ³gicas, comportamentais e mercadolÃ³gicas que possam impactar a adoÃ§Ã£o da soluÃ§Ã£o proposta. Utilize fontes confiÃ¡veis.*
...
### 6.3.1 SegmentaÃ§Ã£o de Mercado

*AtÃ© 250 palavras.*

*Descreva os segmentos de mercado que poderÃ£o ser atendidos pela aplicaÃ§Ã£o.*

*Valor: atÃ© 0,5 ponto.*

### 6.3.2 Perfil do PÃºblico-Alvo

*AtÃ© 250 palavras.*

*Caracterize o pÃºblico-alvo considerando aspectos demogrÃ¡ficos e comportamentais, incluindo necessidades especÃ­ficas, dores e expectativas relacionadas ao problema abordado.*
...
A aplicaÃ§Ã£o resolve um problema concreto da operaÃ§Ã£o do Red Bull 24 Horas: durante 24 horas ininterruptas, operadores anotam Ã  mÃ£o, em pranchetas, os horÃ¡rios de turno e os checkpoints de cada corredor. A fadiga ao longo da madrugada, a caligrafia e as distraÃ§Ãµes tornam esses registros pouco confiÃ¡veis, e nÃ£o existe forma estruturada de auditar o que foi anotado. Como as esteiras do evento nÃ£o se conectam a dispositivos externos, a apuraÃ§Ã£o depende inteiramente desse trabalho manual.

O pÃºblico-alvo da soluÃ§Ã£o se organiza em trÃªs perfis. Na Ã¡rea administrativa estÃ£o os operadores e a equipe de Field Marketing da Red Bull, representados pela coordenadora operacional, que registra checkpoints e trocas de atleta em campo, e pelo gerente de Field Marketing, que supervisiona a prova e analisa os relatÃ³rios. Na Ã¡rea pÃºblica estÃ£o os capitÃ£es e atletas das equipes, que acompanham o desempenho pelo painel acessÃ­vel por link.

O sistema substitui a prancheta por uma captura assistida. O operador fotografa o visor da esteira e a aplicaÃ§Ã£o extrai distÃ¢ncia, pace e tempo por reconhecimento Ã³ptico de caracteres, com conferÃªncia humana antes de salvar e alerta visual para valores que destoem da mÃ©dia do atleta.

Frente a planilhas ou formulÃ¡rios genÃ©ricos, os diferenciais sÃ£o claros: especializaÃ§Ã£o para trocas rÃ¡pidas sob pressÃ£o, validaÃ§Ã£o hÃ­brida entre OCR e operador, rastreabilidade do mÃ©todo de cada checkpoint e acesso pÃºblico por URL com UUID, sem login. Ã essa combinaÃ§Ã£o que sustenta a meta de manter o erro de apuraÃ§Ã£o abaixo de 1%.

### 6.4.2 Posicionamento e DiferenciaÃ§Ã£o

*AtÃ© 250 palavras.*

*Explique como a aplicaÃ§Ã£o pretende ser percebida pelo mercado e quais atributos a diferenciam de alternativas existentes.*

*A anÃ¡lise deve considerar: concorrentes diretos e indiretos; atributos da marca; identidade pretendida; e percepÃ§Ã£o de valor desejada.*
...
*Preencha os nove blocos do Business Model Canvas de forma coerente com as anÃ¡lises realizadas nas seÃ§Ãµes anteriores: Segmentos de clientes; Proposta de valor; Canais; Relacionamento com clientes; Fontes de receita; Recursos principais; Atividades principais; Parcerias principais; e Estrutura de custos, somente se couber neste momento da anÃ¡lise com o parceiro.*

*Valor: atÃ© 2,0 pontos.*

## 6.6 EstratÃ©gia de Marketing (4Ps)

A estratÃ©gia de marketing para o projeto da Redbull 24h foi estruturada com base no modelo dos 4Ps (Produto, PreÃ§o, PraÃ§a e PromoÃ§Ã£o), com o objetivo de definir como a soluÃ§Ã£o gera valor para seus usuÃ¡rios e como pode ser posicionada no mercado de tecnologia aplicada a eventos esportivos. A proposta busca atender Ã s necessidades de organizadores de competiÃ§Ãµes que demandam maior confiabilidade, rastreabilidade e eficiÃªncia operacional na coleta e consolidaÃ§Ã£o de resultados.

Nesse contexto, serÃ£o apresentados os principais atributos da soluÃ§Ã£o, seu modelo de monetizaÃ§Ã£o, os canais pelos quais poderÃ¡ ser disponibilizada e as estratÃ©gias de divulgaÃ§Ã£o que podem contribuir para sua adoÃ§Ã£o. A anÃ¡lise dos 4Ps permite compreender como se diferenciar das abordagens tradicionais de controle manual e como a plataforma pode se tornar uma alternativa competitiva para eventos que necessitam de monitoramento preciso e acompanhamento em tempo real.

### 6.6.1 Produto/ServiÃ§o

*AtÃ© 200 palavras.*

*Descreva as principais funcionalidades, benefÃ­cios e diferenciais da aplicaÃ§Ã£o.*
...
*Apresente o modelo de monetizaÃ§Ã£o ou precificaÃ§Ã£o proposto e sua justificativa.*

*Valor: atÃ© 0,5 ponto.*

### 6.6.3 PraÃ§a (DistribuiÃ§Ã£o)

*AtÃ© 200 palavras.*

*Explique como a aplicaÃ§Ã£o serÃ¡ disponibilizada aos usuÃ¡rios e quais canais serÃ£o utilizados.*
...
*Descreva as estratÃ©gias de divulgaÃ§Ã£o e aquisiÃ§Ã£o de usuÃ¡rios. Podem ser considerados: redes sociais; SEO; marketing de conteÃºdo; campanhas pagas; parcerias; eventos; e estratÃ©gias de relacionamento.*
