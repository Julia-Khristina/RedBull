...
A seguir, são apresentados, no Quadro 22, os requisitos não funcionais do sistema, responsáveis por definir restrições, atributos e métricas de qualidade, como desempenho, segurança e usabilidade, que devem ser considerados ao longo do desenvolvimento.
...
<div align="center">
  <sub>Figura 9 - Diagrama de Fluxo de Telas do Operador da prova</sub><br>
...
<div align="center">
  <sub>Figura 10 - Diagrama de Fluxo de Telas do Corredor</sub><br>
...
representar de forma rápida e simplificada o fluxo de navegação da persona 1 (Marina) ao preparar uma nova edição do Red Bull 24h antes da prova começar, explorando desde o primeiro acesso ao painel até as equipes cadastradas e prontas para receber o link público (UUID).
 ...
 <div align="center">
  <sub>Quadro 24 - User Stories cobertas: </sub>
</div>
...
<div align="center">
 ...
 <div align="center">
  <sub>Quadro 25 - Critérios de baixa fidelidade adotados:</sub>
</div>
...
<div align="center">
  <sub>Figura 11 - Sequência de telas que o operador percorre ao configurar a competição. </sub>
...
<div align="center">
  <sub>Figura 12 - Sequência de telas que o operador percorre ao configurar as equipes. </sub>
...
<div align="center">
  <sub>Figura 13 - Sequência de telas que o operador percorre ao adicionar mais checkpoints. </sub>
...
<div align="center">
  <sub>Figura 14 - Sequência de telas que o operador percorre ao revisar os checkpoints e analisar a competição. </sub>
...
<div align="center">
  <sub>Figura 15 - Painel Operacional do Administrador</sub><br>
  <img src="../assets/design/Equipes - Painel operacional.png" width="70%" alt=""><br>
  <sup>Fonte: Elaborado pelos autores (2026).</sup>
</div>

<div align="center">
  <sub>Figura 16 - Seleção de Atleta Ativo </sub><br>
...
Além disso, o relacionamento entre entidades é feito através de uma linha, que contém as cardinalidades, representação numérica que identifica quantas instâncias de uma entidade podem se relacionar com instâncias de outra. A seguir, o Quadro 26 apresenta as principais cardinalidades e a sua utilização.

<div align="center">
  <sub>Quadro 26 - Cardinalidades </sub>
</div>
...
A seguir, a Figura 17 ilustra o Modelo Entidade Relacionamento desenvolvido para o projeto.

<div align="center">
  <sub>Figura 17 - Modelo Entidade Relacionamento</sub><br>
...
A seguir, o Quadro 27 apresenta cada entidade, seu papel e os relacionamentos que desempenha no sistema.

<div align="center">
  <sub>Quadro 27 - Descrição das entidades e relacionamentos</sub>
</div>
...
A seguir, o Quadro 28 exemplifica os elementos da notação de Chen utilizados no MER.

<div align="center">
  <sub>Quadro 28 - Exemplificação dos elementos da notação de Chen </sub>
</div>
...
O Quadro 29 apresenta a entidade e os atributos de "Competição".

<div align="center">
  <sub>Quadro 29 - Dicionário de Dados da Entidade Competição</sub>
</div>
...
A seguir, o Quadro 30 ilustra a entidade Equipe e os seus atributos.

<div align="center">
  <sub>Quadro 30 - Dicionário de Dados da Entidade Equipe</sub>
</div>
...
O Quadro 31 representa o dicionário de dados da entidade Corredor.

<div align="center">
  <sub>Quadro 31 - Dicionário de Dados da Entidade Corredor</sub>
</div>
...
O Quadro 32 apresenta a entidade e os atributos de "Checkpoint".

<div align="center">
  <sub>Quadro 32 - Dicionário de Dados da Entidade Checkpoint</sub>
</div>
...
A seguir, o Quadro 33 ilustra a entidade Administrador e os seus atributos.

<div align="center">
  <sub>Quadro 33 - Dicionário de Dados da Entidade Administrador</sub>
</div>
...
O Quadro 34 representa o dicionário de dados da entidade Esteira.

<div align="center">
  <sub>Quadro 34 - Dicionário de Dados da Entidade Esteira </sub>
</div>
...
A seguir, o Quadro 35 apresenta a rastreabilidade entre as entidades criadas com os Requisitos Funcionais e Não Funcionais, para assim, ser possível o entendimento e compreensão integral do sistema:

<div align="center">
  <sub>Quadro 35 - Rastreabilidade entidade → RF → RN </sub>
</div>
...
<div align="center">
  <sub>Figura 18 - Diagrama Entidade Relacionamento</sub><br>
...
Com base nos requisitos funcionais, nas regras de negócio e na modelagem conceitual definida nas etapas anteriores, foi elaborado o modelo relacional do sistema, contemplando as principais entidades, seus atributos e os relacionamentos necessários para garantir integridade e consistência dos dados. A Figura 19 apresenta a estrutura relacional proposta para o projeto.

<div align="center">
  <sub>Figura 19 - Modelo Relacional</sub><br>
